        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"> EDIT Notice </h6>
                </div>
                <div class="card-body">
                    <?php

                    if (isset($_POST['edit_pkbtn'])) {
                        $id = $_POST['edit_pkid'];

                        $query = "SELECT * FROM prakad WHERE pk_id='$id' ";
                        $query_run = mysqli_query($conn, $query);

                        foreach ($query_run as $row) {
                            $edit_text = $row['txtmssge'];
                            ?>
                            <form action="code.php" method="POST" enctype="multipart/form-data">
                                ...
                                <br>
                                <a href="notice_manage.php" class="btn btn-danger"> CANCEL </a>
                                <button type="submit" name="update_pkbtn" class="btn btn-primary"> Update </button>
